...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                ?>
                            ...
                            <li style="margin-left:30px;"><a href="javascript:void(0);" class=" btn-default" style="padding: 0px 6px;font-size: 12px;" data-toggle="modal" data-target="#add_attendence"><i data-toggle="tooltip" data-placement="top" title="Add New" style="color:#f58c1f" class="fas fa-plus"></i>Add</a></li>
  ...
  <!--                                             <label class="fancy-checkbox">
                                          ...
                                          <td>
                                          @foreach($userList as $ue)
                                            @if($user->user_id == $ue->emp_id) 
                                          <h6 class="mb-0">{{$ue->name}}</h6>
                                            @endif
                                            @endforeach
                                              </td>
