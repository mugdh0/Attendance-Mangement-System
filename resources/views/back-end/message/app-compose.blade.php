                        ...
                        <div class="body">
                            <form method="POST" action="{{ route('send-message') }}" enctype='multipart/form-data'>
                                ...
                                <div class="form-group">
                                    <input type="email" required name="msg_receiver" class="form-control" placeholder="To">
                                </div>
                                <div class="form-group">
                                    <input type="text" required name="subject" class="form-control" placeholder="Subject">
                                </div>
                                <div class="form-group">
                                    <input type="email" required name="cc" class="form-control" placeholder="CC">
                                </div>
                           
                            {{-- <hr> --}}
                            <div >
                               <textarea class="summernote" required name="msg"></textarea>
                            </div>
                            <div class="m-t-30">
