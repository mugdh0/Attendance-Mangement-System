                                ...
                                <div class="mail-action clearfix">
                                    <div class="pull-left">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a href="javascript:void(0);" class="btn btn-default btn-sm delete_all" data-url="{{ url('trashMailsDeleteAll') }}" ><i class="fa fa-trash"></i> Empty</a>
                                            <a href="javascript:void(0);" class="btn btn-default btn-sm restore_all" data-url="{{ url('trash-Mails/restore') }}" ><i class="fas fa-redo"></i> Restore</a>
                                        </div>
...
@foreach($messages as $key=> $message)
                                        <li class="clearfix">
                                            ...
                                            <h6 class="sub"><a href="{{route('msg-details',['id'=>$message->id])}}" class="mail-detail-expand">{{$message->subject}}</a> </h6>
                                            <p class="dep"><span class=""></span>{!! $message->msg !!}</p>
                                            <span class="time">{{ Carbon\Carbon::parse($message->created_at)->diffForHumans() }}</span>
                                            </div>
                                            <div class="hover-action">
                                                <a class="btn btn-warning mr-2" href="{{route('restore-trashed-message',['id'=>$message->id])}}" title="Restore Message" data-toggle="tooltip" data-placement="top"><i class="fas fa-redo"></i></a>
                                            <a class="btn btn-danger text-white" href="{{route('delete-trashed-message',['id'=>$message->id])}}" title="Delete" data-toggle="tooltip" data-placement="top"><i class="fa fa-trash-o"></i></a>
                                            </div>
                                        </li>
@endforeach
...
{  
    ...
    var check = confirm("Are you sure you want to restore this messages?");  
    if(check == true){  
